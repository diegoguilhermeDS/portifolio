...
const CardEmphasis = ({ repositoryEmphasis }: iCardEmphasisProps) => {
  ...
  return (
    <div className="flex gap-8 w-[820px] p-4 py-8 bg-brand-300 shadow-card">
      <div className="w-[440px] h-[300px] overflow-hidden rounded-lg">
        <Image
      ...
      <div className="flex flex-col justify-between gap-6 max-w-[300px]">
