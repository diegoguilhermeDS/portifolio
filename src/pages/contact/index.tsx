...
export default function contact() {
  return (
    <main className="flex flex-col items-center gap-12 container overflow-hidden p-2 pt-40 mx-auto min-h-screen mt-16 lg:flex-row lg:justify-around lg:items-start lg:mt-0">
