  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        react:  "0px 0px 10px #151515, 0px 0px 40px #00D8FF, 0px 0px 80px #00D8FF",
        ...
        github:  "0px 0px 10px #151515, 0px 0px 40px #D4D4D4, 0px 0px 80px #2E2C2C",
        git:  "0px 0px 10px #151515, 0px 0px 40px #EE513B, 0px 0px 80px #EE513B",
        figma:  "0px 0px 10px #151515, 0px 0px 40px #F94B12,  0px 0px 50px #00BCFF, 0px 0px 70px #00CF7F, 0px 0px 80px #B659FF",
      },
      animation: {
